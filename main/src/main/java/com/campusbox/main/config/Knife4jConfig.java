...
public class Knife4jConfig {
    ...
    public Docket adminApiConfig(){
        ...
        Docket adminApi = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //只显示admin路径下的页面
                .apis(RequestHandlerSelectors.basePackage("com.campusbox"))
    ...
    private ApiInfo adminApiInfo(){
        ...
        return new ApiInfoBuilder()
                .title("campusbox-API文档")
                .description("本文档描述了compus后台管理系统接口")
                .version("1.0")
                .contact(new Contact("wuboxin", "http://campusbox.com", "wuboxin98@outlook.com"))
                .build();
    }
